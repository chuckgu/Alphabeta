import numpy as np
from library.Layers import Drop_out,Embedding,FC_layer,Pool,Activation,Flatten
...
from library.external.mnist import load_data


np.random.seed(1337)  # for reproducibility

from library.Convolutional_Layer import Convolution2D, MaxPooling2D
...
model.compile( optimizer='Adadelta',loss='categorical_crossentropy', mask=False)

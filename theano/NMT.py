...
n_words_x=14000 ## max numbers of words in dictionary
n_words_y=14000 ## max numbers of words in dictionary
...
load_file='data/conv.pkl'
dic_file='data/conv.dict.pkl'

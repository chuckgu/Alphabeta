...
n_gen_maxlen=30 ## max length of generated sentences
n_words_x=6206 ## max numbers of words in dictionary + 2(EOS,UNK)
...
load_file='data/kaggle.pkl'
dic_file='data/kaggle.dict.pkl'

train, valid, test = load_data(load_file,n_words=n_words_x, valid_portion=0.05,
                               maxlen=None)
...
print 'number of training data: %i'%len(seq)
print 'number of validation data: %i'%len(val)

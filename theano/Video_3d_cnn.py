...
model.add(Convolution3D(64,1, nb_channel , nb_conv, nb_conv,padding=(1,1,1)))
model.add(Activation('relu'))
model.add(MaxPooling3D(poolsize=(nb_pool, nb_pool, nb_pool),stride=(2, 2, 1)))

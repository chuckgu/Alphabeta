...
from library.Model import ENC_DEC
...
n_words_x=8000 ## max numbers of words in dictionary
n_words_y=8000 ## max numbers of words in dictionary
...
load_file='data/conv_bet.pkl'
dic_file_x='data/conv_bet.dict1.pkl'
dic_file_y='data/conv_bet.dict2.pkl'
